...
export function DataTable<TData, TValue>({
  ...
  return (<>
    <div className="h-[60px] flex items-center w-[100vw] bg-blue-400">
      <CardTitle className="h-full  flex items-center flex-1 justify-center text-white">Instruments</CardTitle>
    </div>
    <div className="flex gap-2 container mx-auto">
      ...
      <Select onValueChange={(value)=>{handleSelectChange(value)}}>
        ...
        <SelectContent>
            <SelectItem key={1} value="instrument">Instrument</SelectItem>
        </SelectContent>
      </Select>
